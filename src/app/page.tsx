    ...
    <main className="flex flex-col items-center justify-center min-h-screen px-6 py-12 bg-gray-200 text-black">
      ...
      >
        ...
        <p className="text-lg mb-8 px-4 py-3 border-4 border-black bg-pink-300 shadow-[6px_6px_0px_black] rounded-lg">
          A fun, gamified platform that turns GitHub contributions into friendly
          competition. Developers earn points for creating issues, reviewing
          pull requests, and merging code — all tracked and displayed on a
          colorful scoreboard.
        </p>
