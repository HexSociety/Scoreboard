...
import Developers from "./components/Footer";
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-6 py-12 relative">
      ...
      <motion.div
        ...
        className="mb-16 p-6 bg-white/90 border-4 border-black neobrutalist-shadow-lg rounded-2xl max-w-2xl relative z-10"
      >
        <h3 className="text-2xl font-black mb-4 text-center">⚡ Points System</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
          <div className="text-center p-3 bg-pink-100 border-2 border-black rounded-lg">
            <div className="text-2xl mb-1">📝</div>
            <div className="font-bold">Create Issue</div>
            <div className="text-purple-600 font-black">+5 pts</div>
          </div>
          <div className="text-center p-3 bg-blue-100 border-2 border-black rounded-lg">
            <div className="text-2xl mb-1">🔀</div>
            <div className="font-bold">Open PR</div>
            <div className="text-purple-600 font-black">+10 pts</div>
          </div>
          <div className="text-center p-3 bg-green-100 border-2 border-black rounded-lg">
            <div className="text-2xl mb-1">👀</div>
            <div className="font-bold">Review PR</div>
            <div className="text-purple-600 font-black">+8 pts</div>
          </div>
          <div className="text-center p-3 bg-yellow-100 border-2 border-black rounded-lg">
            <div className="text-2xl mb-1">✅</div>
            <div className="font-bold">Merge PR</div>
            <div className="text-purple-600 font-black">+20 pts</div>
          </div>
        </div>
      </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="font-medium text-purple-800">
              Create issues, open pull requests, review code, and help improve
          ...
          >
            ...
            <p className="font-medium text-orange-800">
              Every action earns you points automatically tracked from GitHub
